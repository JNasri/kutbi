...
const fallbackPosts: BlogPost[] = [
  {
    ...
    gallery_images: [],
    title_ar:
      "\u0631\u062d\u0644\u0629 \u062a\u0628\u062f\u0623 \u0628\u062d\u0641\u0627\u0648\u0629 \u0633\u0639\u0648\u062f\u064a\u0629",
    title_en: "A journey shaped by Saudi hospitality",
    excerpt_ar:
      "\u0642\u0635\u0635 \u0648\u0646\u0635\u0627\u0626\u062d \u0645\u0644\u0647\u0645\u0629 \u0644\u0631\u062d\u0644\u0629 \u0623\u0643\u062b\u0631 \u062b\u0631\u0627\u0621\u064b \u0648\u0631\u0627\u062d\u0629.",
    excerpt_en:
      "Stories and practical inspiration for a richer, more comfortable journey across the Kingdom.",
    content_ar: "",
    content_en: "",
  },
  {
    ...
    excerpt_ar:
      "\u062a\u0639\u0631\u0641 \u0639\u0644\u0649 \u0623\u0633\u0637\u0648\u0644\u0646\u0627 \u0648\u0643\u064a\u0641 \u0646\u062e\u0637\u0637 \u0644\u0643\u0644 \u0627\u0646\u062a\u0642\u0627\u0644 \u0628\u0639\u0646\u0627\u064a\u0629.",
    excerpt_en:
      "Discover how our fleet supports every transfer, from arrival through departure.",
    content_ar: "",
    content_en: "",
  },
  {
    ...
    gallery_images: [],
    title_ar:
      "\u0627\u0643\u062a\u0634\u0641 \u0648\u062c\u0647\u064b\u0627 \u062c\u062f\u064a\u062f\u064b\u0627 \u0644\u0644\u0645\u0645\u0644\u0643\u0629",
    title_en: "Discover a new side of Saudi Arabia",
    excerpt_ar:
      "\u0648\u062c\u0647\u0627\u062a \u062f\u064a\u0646\u064a\u0629 \u0648\u062b\u0642\u0627\u0641\u064a\u0629 \u0648\u0637\u0628\u064a\u0639\u064a\u0629 \u0645\u062e\u062a\u0627\u0631\u0629 \u0644\u0631\u062d\u0644\u0629 \u0644\u0627 \u062a\u0646\u0633\u0649.",
    excerpt_en:
      "Religious, cultural, and natural destinations selected for unforgettable journeys.",
    content_ar: "",
    content_en: "",
  },
];
  ...
  if (!posts) {
    return (
      <aside
        ...
        aria-label={
          language === "ar" ? "جارٍ تحميل أحدث القصص" : "Loading latest stories"
        }
        aria-busy="true"
      >
        <div className="hero-blog-loading-image" />
        <div className="hero-blog-loading-copy">
          <i />
          <i />
          <i />
        </div>
